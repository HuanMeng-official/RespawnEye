...
public class ReBlocks {
    ...
    public static Block registerBlocks(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(RespawnEye.MODID, name), block);
    }

    public static void registerBlockItems(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(RespawnEye.MODID, name), new BlockItem(block, new Item.Settings()));
    }
